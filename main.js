...
console.log("It worked!");
    ...
    //Pop-up stuff
    document.body.innerHTML += '<dialog id="dialog" style="width: 320px; height: 320px;"><center><font size = "+10">Smile!</font></center><video id="video" width="320" height="240" autoplay="true"></video><center><br><button>Close</button></center></dialog>';
